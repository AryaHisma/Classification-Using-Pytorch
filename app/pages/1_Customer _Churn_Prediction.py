...
with col2:
    ...
    **Prediksi :**
    ...
    pipeline_loaded = joblib.load('app/model/binaryclass/preprocessing_pipeline.pkl')
    ...
    # Load Model
    model3 = torch.load('app/model/binaryclass/model_churn3.pth', weights_only=False)
